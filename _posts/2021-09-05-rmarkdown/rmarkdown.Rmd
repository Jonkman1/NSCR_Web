...
<<<<<<< HEAD
```{r, out.width="50%"}
knitr::include_graphics("workshop2.png")
```
=======
>>>>>>> f3ce3044101f16aac457d78e1f059d5f41e191d5
...
Here you can find the [presentation, scripts and additional materials](https://github.com/Jonkman1/NSC_R/tree/main/Meeting_2_RMarkdown/nsc_r_workshop/scripts).
