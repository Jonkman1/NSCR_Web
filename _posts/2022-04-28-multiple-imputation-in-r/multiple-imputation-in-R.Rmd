...
To get an idea of what the workshop is about, you could read (in Dutch) [his short and accessible overview of multiple imputation](https://stefvanbuuren.name/publications/2012%20Vogelvlucht%20-%20STAtOR.pdf). Alternatively, you could check out the (English) [Wikipedia page](https://en.wikipedia.org/wiki/Imputation_(statistics)).
