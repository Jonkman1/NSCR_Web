...
description: How to organize your research workflow in R to create documented code and reproducible findings.
...
Here you find the [presentation](https://www.dropbox.com/s/vn7rn9m5ht2miol/reproducibility.pdf?dl=0)
...
- If you are using R already and in particular if you use tidyverse, a long book-down document about [coding style conventions](https://style.tidyverse.org/index.html).    

- A wonderful but distressing lecture (and long: about 50 minutes) from Richard McElreath about working with software in the social sciences, with a criminology paper example in the end on racial disparity in police use of deadly force. [Click this YouTube link](https://www.youtube.com/watch?v=zwRdO9_GGhY).

You may also want to consult this textbook:

Gandrud, C. *Reproducible Research with R and RStudio, Second edition*. [Click to download the PDF](https://radhakrishna.typepad.com/reproducible-research-with-r-and-rstudio---second-edition.pdf) 
