...
This workshop session was about using R for **regression analysis**, both in a **non-spatial and a spatial context**. Wouter and Stijn will be presenting parts of what they prepared for a [recent book chapter](https://osf.io/jwnqx) (in press).These materials were scaned to get an idea of what the workshop will cover.Here you can find the data, the syntax and the html-file presented [material](https://github.com/Jonkman1/NSCR_Web/tree/main/_posts/2021-09-27-spatialregression)
